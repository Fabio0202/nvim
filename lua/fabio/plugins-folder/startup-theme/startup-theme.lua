--simon every line should be same width without escaped \
local ascii_art_module = require "fabio.plugins-folder.startup-theme.ascii-banners" -- Adjust the path as needed
local selected_art = ascii_art_module.random_ascii_art()

local random_tips = require("fabio.plugins-folder.startup-theme.random-tips") -- Adjust the path as needed
